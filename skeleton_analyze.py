...
if __name__ == '__main__':
    ...
    ap.add_argument("--min_dis", required = False, type = int, default = 35,   help = "min distance for watershed segmentation")
    ap.add_argument("--dis_tracking_ratio", required = False, type = float, default = 0.71,   help = "ratio for tracking")
    ap.add_argument("--distance_tracking_max", required = False, type = float, default = 1.12,   help = "max distance for tracking segs")
    ap.add_argument("--distance_tracking_min", required = False, type = float, default = 0.50,   help = "min distance for tracking segs")
    ap.add_argument("--distance_tracking_avg", required = False, type = float, default = 1.41,   help = "avg distance for tracking segs")
    ap.add_argument("--thresh_distance_ratio", required = False, type = float, default = 1.41,   help = "paramter to smooth the 1d curve")
    ap.add_argument("--snake_speed_max", required = False, type = float, default = 0.32,   help = "min distance for watershed segmentation")
    ap.add_argument("--snake_speed_min", required = False, type = float, default = 0.90,   help = "paramter to smooth the 1d curve")
    ap.add_argument("--kernel_max_radius", required = False, type = float, default = 1.12,   help = "max convolution kernel radius")
    ap.add_argument("--kernel_min_radius", required = False, type = float, default = 0.77,   help = "min convolution kernel radius")
    ap.add_argument("--span", required = False, type = float, default = 3,   help = "paramter to smooth the 1d curve")    
    ap.add_argument("--visualize_model", dest = "visualize_model", required = False, type = int, default = 0, help = "Display model or not, deafult not display")
